...
function Get-ZodiacAnimal {
    ...
    <#
        ...
        Chinese and Korean Lunar year follows the Gregorian Calendar. The Japanese Lunar year follows the reign
        of the current emperor (Emperor Naruhito), which started in 2019 (Year 1). The Taiwanese Lunar year follows 
        the Republic of China calendar, which started in 1912 (Year 1).
    #>
    param (
        [Parameter(Mandatory, Position = 0)]
        [string]$Calendar,
    ...
    process {
        switch ($Calendar) {
            'JapaneseLunisolar' {
                ...
                Write-Output $Animal[$AnimalIndex]
                break 
            }
            'KoreanLunisolar' { 
...
function Get-NCalendar {
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('Year') -and $Calendar -match 'Lunisolar') {
            $ZodiacAnimal = Get-ZodiacAnimal -Calendar $Calendar -Year $Year
