...
function Get-Calendar {
    ...
    begin {
        ...
        # with to get best formatting results. Long day names not supported with cal.
        $Param = @{
            'Culture'         = $ThisCulture
    ...
    process {
        foreach ($RequiredMonth in $MonthList) {
            ...
            $PrintMonth = $RequiredMonth.PrintMonth
        ...
        # Write the last month or row of months. Print a year heading before Month 1 when year is specified
